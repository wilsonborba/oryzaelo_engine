...
| **Percentil 95 (p95)** | **22.840 µs (0.0228 ms)** | < 5,0 ms | < 200,0 ms | **Aprovado** |
| **Percentil 99 (p99)** | **25.144 µs (0.0251 ms)** | < 5,0 ms | < 200,0 ms | **Aprovado** |
| **Mínimo Absoluto** | **20.250 µs** | - | - | - |
| **Máximo Absoluto** | **28.560 µs** | - | - | - |
